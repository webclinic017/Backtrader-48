...
class Plotter:
    ...
    def plot(self):
        self.main_plot.append(mpf.make_addplot(self.asset_change, type='line', color='black'))
        self.main_plot.append(mpf.make_addplot(self.open_place, type='scatter', marker='^', markersize=100))
        self.main_plot.append(mpf.make_addplot(self.close_place, type='scatter', marker='v', markersize=100))
        
        mpf.plot(self.dataframe, type='candle', style='binance', addplot=self.main_plot, main_panel=0, volume=True)
        plt.show()